...
#   test(args.test_datasets, model, start_epoch, summary)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        loss = train(train_loader, model, criterion, criterionB, optimizer, epoch, summary=None)
        
        # evaluate on test datasets every test_freq epochs
        with torch.no_grad():
            if args.val:
                loss = validate(val_loader, model, criterion, criterionB, epoch, summary=None)
