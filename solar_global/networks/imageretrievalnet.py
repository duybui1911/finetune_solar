...
class SOLAR_Global_Retrieval(nn.Module):
    ...
    def forward(self, x):
        ...
        #     print("x_map",x_map)
        #     print("w_map",w_map)
        #     o=o[:,:,y_map:(y_map+h_map),x_map:(x_map+h_map)]
        #     print("o",o.shape)
        ###############################
    ...
    def __repr__(self):
        tmpstr = super(SOLAR_Global_Retrieval, self).__repr__()[:-1]
...
def extract_vectors(net, images, image_size, transform, bbxs=None, ms=[1], msp=1, print_freq=10, summary=None, bs=1,mode='test'):
    ...
    loader = torch.utils.data.DataLoader(
            ...
            batch_size=bs, shuffle=False, num_workers=8, pin_memory=True
        )
